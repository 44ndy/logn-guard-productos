...
export class ProductoService {
  ...
  public listarProductos() {
    ...
    this.http.get<ProductoRespuesta>(url_nueva, {
      ...
      this.$productos.next(datos.products); // Actualiza el BehaviorSubject con la lista de productos
      this.total = datos.total; // Actualiza el total de productos
    });
  }
  ...
  public siguientesProductos() {
    ...
    this.http.get<ProductoRespuesta>(url_nueva, {
      ...
      this.$productos.next(datos.products); // Emite la lista de productos actualizada
      this.total = datos.total; // Actualiza el total de productos
    });
  }
